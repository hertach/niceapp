...
def settings_page() -> None:
    ...
    with ui.row().classes('w-full flex-nowrap items-start min-h-[calc(100vh-120px)]'):
        ...
        menu_container = ui.column().classes('w-[240px] shrink-0 border-r border-[#e2e8f0] h-full pr-4 gap-1')
    ...
    def render_menu() -> None:
        ...
        with menu_container:
            ...
            def menu_item(tab_id: str, label: str, icon: str):
                ...
                bg_class = 'bg-[#eef2ff] text-[#0078d4]' if is_active else 'text-[#475569] hover:bg-slate-100'
